...
@description('Required. Tags: ApplicationName, AppPriority, ChargeCode, DataProtectionCategorization.')
param tags object
...
var applicationGatewayName = '${agencyCode}${envCode}-${appName}-agw-${numberCode}'
...
var applicationGatewayPIPName = '${applicationGatewayName}-pip'
var frontendPublicIpResourceId  = appgwpip.id
